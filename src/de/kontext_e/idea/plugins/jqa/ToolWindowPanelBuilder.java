...
public class ToolWindowPanelBuilder {
    public static JPanel buildToolWindowPanel(final Project project) {
		...
		JComboBox queryHistory = new JComboBox();
		gbc = new GridBagConstraints();
		gbc.gridx = 0;
		gbc.gridy = 2;
		gbc.weightx = 1.0;
...
//        gbc.weighty = 1.0;
        ...
        button1.addActionListener(new FindInNeo4jDatabaseAction(matchNCLASSReturnTextArea, tmpStoreTextField, queryHistory, project));
